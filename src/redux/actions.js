...
import { auth, googleAuthProvider, githubProvider } from "../firebase";
...
export const githubSignInInitiate = () => {
  console.log("GitHub sign-in initiate action");
  return function (dispatch) {
    ...
    auth
      ...
      .catch((error) => {
        console.log("GitHub sign-in error:", error); // Log the error
